...
function Header() {
  ...
  return (
    <motion.header
      className="fixed left-1/2 -translate-x-1/2 z-50 w-full transition-all duration-500"
    ...
    >
      <motion.nav
        className={`bg-black/85 backdrop-blur-xl border-b transition-all duration-500 ease-out ${
          isScrolled 
            ? 'bg-black/92 border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.5)]' 
